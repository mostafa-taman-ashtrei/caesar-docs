...
const ChatMessages: React.FC<ChatMessagesProps> = ({ fileId }) => {
    ...
    return (
        <div className="flex max-h-[calc(100vh-1.5rem-7rem)] flex-1 flex-col-reverse gap-4 overflow-y-auto border-zinc-200 p-3 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-secondary">
